...
class ProfilingRunner():
    ...
    def print_summary_statistics(self):
        ...
        for profiled_cond, raw_data in self.raw_data.items():
            ...
            Profiler.WriteProfileData(datetime.now(),str(profiled_cond),float(profiled_avg),float(profiled_min),float(profiled_max),float(profiled_stdev),profiled_count);
            # print to log
...
if __name__ == '__main__':
    ...
    profiler = ProfilingRunner()
    profiler.print_summary_statistics()